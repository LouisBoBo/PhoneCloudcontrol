...
public class MyLoadingPopupView extends CenterPopupView {
     ...
     */
    public MyLoadingPopupView(@NonNull Context context, int bindLayoutId) {
        super(context);
    ...
    protected void initPopupContent() {
        ...
        if(bindLayoutId==0){
            getPopupImplView().setBackground(XPopupUtils.createDrawable(Color.parseColor("#dd222222"), popupInfo.borderRadius));
        }
        setup();
    }
    ...
    public MyLoadingPopupView setTitle(CharSequence title) {
        this.title = title;
        setup();
        return this;
    }
