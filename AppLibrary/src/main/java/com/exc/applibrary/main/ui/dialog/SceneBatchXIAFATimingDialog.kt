...
class SceneBatchXIAFATimingDialog(private var list: ArrayList<ControllerByIdSceneNameBean.Data.list>?) : DialogFragment(), View.OnClickListener, OnHttpResponseListener {
    ...
    companion object {
        ...
        fun showDialog(myList: ArrayList<ControllerByIdSceneNameBean.Data.list>?, fragmentManager: FragmentManager) {
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            ...
            R.id.ll_zhixing -> {
                ...
                dismiss()
                loadIngDialg.dismiss()
                HttpRequest.scenePIliangXiafaTiming(type, beginDate, endDate, cycleTypes, list, 1, this)
            }
