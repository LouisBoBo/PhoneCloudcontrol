 ...
 * @see #onDestroy
 */
public abstract class BaseTakePhotoActivity extends TakePhotoActivity implements ActivityPresenter, OnGestureListener {
     ...
     * @warn 不能在子类中创建
     */
    protected BaseTakePhotoActivity context = null;
    /**
...
//        }
        ...
        context = (BaseTakePhotoActivity) getActivity();
        isAlive = true;
